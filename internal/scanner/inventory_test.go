...
// These will be replaced by actual brew package functions once Agent A completes

// mockListInstalled simulates brew.ListInstalled() for testing
func mockListInstalled() ([]*brew.Package, error) {
	return []*brew.Package{
		{
			Name:        "git",
			Version:     "2.43.0",
...
// mockGetDependencyTree simulates brew.GetDependencyTree() for testing
func mockGetDependencyTree(pkg string) ([]string, error) {
...
// mockGetBrewPrefix simulates brew.GetBrewPrefix() for testing
func mockGetBrewPrefix() (string, error) {
